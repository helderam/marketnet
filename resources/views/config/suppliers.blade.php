...
<form action="/suppliers" method="get">
  ...
  <?php echo simpleHeadTable(route('suppliers.create')); ?>
    ...
    <div class="col-12">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <table class="bg-white table table-striped table-hover nowrap rounded table-striped table-sm" cellspacing="0">
            <thead>
              <tr>
                ...
                <th> <?php echo simpleColumn('code', 'CNPJ') ?></th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$supplier->code}}</td>
                <td>{{$supplier->name}}</td>
                <td>{{simpleDateFormat($supplier->created_at)}}</td>
                <!-- BOTÕES DE AÇÃO -->
                <td>
                  <?php echo simpleAction('EDITAR', 'suppliers.edit', 'info', 'fa-edit', $supplier->id); ?>
                </td>
              </tr>
              @endforeach
              </body>
          ...
          <?php echo simpleFootTable($suppliers) ?>
          <!-- FIM - RODAPE -->
